...
// CORS configuration (supports multiple origins via comma-separated env)
const allowedOrigins = (process.env.CORS_ORIGIN && process.env.CORS_ORIGIN.split(',').map(o => o.trim())) || ['http://localhost:5174'];
app.use(cors({
