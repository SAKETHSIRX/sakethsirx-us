...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Check more specific sections before "home" to avoid home matching when nested sections are in view
      const sections = [
        "featured-projects",
        "pricing",
        "contact",
  ...
  const handleTabChange = (index: number | null) => {
    ...
    if (selectedTab) {
      if (selectedTab.title === "Subscribe") {
        navigate("/checkout");
        return;
      }
  ...
  return (
    <div className={isDarkMode ? "bg-black text-white" : "bg-white text-black"}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            >
              saketh<span className="text-red-500">sirx</span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              >
                {isDarkMode ? (
                  ...
                  <Moon
                    size={18}
                    className="text-black/70 group-hover:text-black"
                  />
                )}
              </button>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full pt-44">
          {/* Main Heading */}
          <h1
          ...
          >
            This is Saketh<span className="text-red-500">sirx</span>
          </h1>
          ...
          >
            Every <span className="text-red-500">pixel holds intent</span>, and
            every <span className="text-red-500">frame speaks emotion</span>.
            From <span className="text-red-500">concept to creation</span>,{" "}
            <span className="text-red-500">~we</span> craft experiences that
            <span className="text-red-500"> truly connect...</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            >
              Order <span className="text-red-500">your own! →</span>
            </button>
            <button
            ...
            >
              <Code size={16} />
              View<span className="text-red-500"> Portfolio</span>
            </button>
          </div>
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
              <div className="text-center mb-16 mt-5">
                ...
                >
                  I'm not just an editor — I edit your story,
                  <span className="text-red-500"> As you dreamed !!</span>
                </p>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative">
                  <div
                    className={`rounded-2xl overflow-hidden aspect-[4/4] max-w-md mx-auto ${
                      isDarkMode ? "bg-gray-800" : "bg-gray-200"
                    }`}
                  >
                    <img
                      src="/sakethsirx insta dp.jpg"
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    >
                      At sakethsirx, I transform raw footage into meaningful
                      visual experiences. From cinematic reels to memory-rich
                      montages, every edit is crafted with purpose and emotion.
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    >
                      ...
                      >
                        Precision editing, seamless transitions, and
                        storytelling control — built for creators who value flow
                        and feel.
                      </p>
                    </div>
                    ...
                    >
                      ...
                      >
                        Where motion meets magic. I use After Effects to add
                        energy, emotion, and visual impact to your content.
                      </p>
                    </div>
                  </div>
          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
              <div className="text-center mb-16 mt-5">
                ...
                >
                  Let's Get in to{" "}
                  <span className="text-red-500">My Socials</span>
                </h2>
                <p
                ...
                >
                  ...
                  <span className="text-red-500">let’s grow together.”</span>
                </p>

                {/* Social Media Icons */}
                <div className="flex justify-center items-center gap-10 mt-10 flex-wrap">
                  <a
                    href="https://www.instagram.com/sakethsirx_ae"
                    target="_blank"
                  ...
                  <a
                    href="https://www.youtube.com/@sakethsirx"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`w-12 h-12 rounded-lg flex items-center justify-center transition-colors duration-300 group ${
                      isDarkMode
                  ...
                  <a
                    href="https://www.facebook.com/sakethsirx"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`w-12 h-12 rounded-lg flex items-center justify-center transition-colors duration-300 group ${
                      isDarkMode
                  ...
                  <a
                    href="https://www.linkedin.com/in/saketh-ram-gundrasam-7906572bb"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`w-12 h-12 rounded-lg flex items-center justify-center transition-colors duration-300 group ${
                      isDarkMode
                  ...
                  <a
                    href="https://github.com/SAKETHSIRX"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`w-12 h-12 rounded-lg flex items-center justify-center transition-colors duration-300 group ${
                      isDarkMode
            ...
            <div>
              ...
              >
                What Makes Me <span className="text-red-500">Stand Out</span>
              </h2>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    >
                      Client <span className="text-red-500">Privacy</span>
                    </h3>
                    <p
                    ...
                    >
                      Your clips, your story — handled with complete
                      confidentiality. Every project stays secure and personal.
                    </p>
                  </div>
                </GlowCard>
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    >
                      High <span className="text-red-500">Quality</span>
                    </h3>
                    <p
                      className={`text-sm leading-relaxed flex-grow ${
                        isDarkMode ? "text-gray-400" : "text-gray-600"
                    ...
                    >
                      Each frame is carefully cut, colored, and crafted to
                      deliver cinematic, emotion-rich edits that stand out.
                    </p>
                  </div>
                </GlowCard>
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    >
                      On-Time <span className="text-red-500">Delivery</span>
                    </h3>
                    <p
                      className={`text-sm leading-relaxed flex-grow ${
                        isDarkMode ? "text-gray-400" : "text-gray-600"
                    ...
                    >
                      No delays, no excuses. I respect your time and guarantee
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    >
                      Transparent <span className="text-red-500">Process</span>{" "}
                    </h3>
                    <p
                      className={`text-sm leading-relaxed flex-grow ${
                        isDarkMode ? "text-gray-400" : "text-gray-600"
                    ...
                    >
                      Want to see how your story comes to life? I openly share
                      my editing process when requested — full transparency, no
                      secrets.
                    </p>
                  </div>
                </GlowCard>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 mt-5">
            ...
            >
              Explore some of my latest work and creative projects available for
              free download.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Project 1 */}
            <div
              className={`border rounded-xl overflow-hidden hover:border-gray-700 transition-all duration-300 group ${
                isDarkMode
                  ? "bg-gray-900/50 border-gray-800"
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  Professional color correction tutorial with dark aesthetic
                  effects.
                </p>
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  Cinematic reflection effects with water and motion graphics.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
                    ₹0.00
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  "Cardigan"🌊🌀 | Demon Slayer [AMV/edit] (🖤 FREE PF)
                </h4>
                <p
                  className={`text-sm mb-4 ${
                    isDarkMode ? "text-gray-400" : "text-gray-600"
                ...
                >
                  Demon Slayer AMV with emotional storytelling and smooth
                  transitions.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  "INFECTED"🧟 | Tengen Uzui [AMV/edit] (🖤 FREE PF)
                </h4>
                <p
                  className={`text-sm mb-4 ${
                    isDarkMode ? "text-gray-400" : "text-gray-600"
                ...
                >
                  High-energy Tengen Uzui AMV with infected theme and dynamic
                  effects.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  Romantic edit with soft transitions and emotional
                  storytelling.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  "WANDERER"🔥 | Dandadan [AMV/edit] (🔥QUICK🔥 FREE PF)
                </h4>
                <p
                  className={`text-sm mb-4 ${
                    isDarkMode ? "text-gray-400" : "text-gray-600"
                ...
                >
                  Fast-paced Dandadan AMV with fire effects and quick cuts.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
                    ₹0.00
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  Complete Iguro editing pack with 3k resolution assets and
                  effects.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  "LEVI"💀 | Dead on Arrival [+Free project file]
                </h4>
                <p
                  className={`text-sm mb-4 ${
                    isDarkMode ? "text-gray-400" : "text-gray-600"
                ...
                >
                  Attack on Titan Levi edit with project file included for
                  learning.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
            ...
            >
              ...
              <div className="p-6">
                ...
                >
                  Dynamic edit with stop-motion effects and creative
                  transitions.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-green-400">
          ...
          <div className="text-center mt-12">
            ...
            >
              ...
              View <span className="text-red-500">All Projects</span>
            </button>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Short Edit */}
            <div
              className={`border rounded-xl p-8 flex flex-col transition-colors duration-300 ${
                isDarkMode
                  ? "bg-gray-900/50 border-gray-800"
                  : "bg-gray-50/50 border-gray-200 hover:border-gray-400"
              }`}
            >
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {/*MAY B USEFULL LATER- description for the sublines  */}
                    {/* 
                    <p
                      className={`text-sm ${
                        isDarkMode ? "text-gray-400" : "text-gray-600"
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Sound sync and smooth transitions
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Optimized for Instagram, YouTube Shorts, etc.
                    </span>
                  </div>
                </li>
              </ul>
              ...
              <div className="mt-auto text-center">
                <button
                  onClick={() => navigate('/checkout?plan=short-edit')}
            ...
            >
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Detailed editing and scene structure
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Perfect for vlogs, events, or YouTube content
                    </span>
                  </div>
                </li>
              </ul>
              ...
              <div className="mt-auto text-center">
                <button
                  onClick={() => navigate('/checkout?plan=full-length-video')}
                  className={`text-lg font-semibold px-4 py-2 rounded-md transition-colors duration-300 ${
                    isDarkMode
                      ? "bg-white text-black hover:bg-gray-300"
                      : "bg-black text-white hover:bg-gray-800"
            ...
            {/* Combo Pack */}
            <div
              className={` relative border rounded-xl p-8 transition-colors duration-300 ${
                isDarkMode
            ...
            >
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Full-length video edit (7-10 min)
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      30-40 sec short reel from the same content
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Brand-consistent transitions and effects
                    </span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Ideal for creators, influencers, or businesses
                    </span>
                  </div>
                </li>
              </ul>
              ...
              <div className="text-center">
                <button
                  onClick={() => navigate('/checkout?plan=combo-pack')}
                  className={`text-lg font-semibold px-4 py-2 rounded-md transition-colors duration-300 ${
                    isDarkMode
                      ? "bg-white text-black hover:bg-gray-300"
                      : "bg-black text-white hover:bg-gray-800"
          ...
          <div className="text-center mt-16">
            ...
            >
              Need a <span className="text-red-500">Custom Quote?</span>
            </h3>
            <p
            ...
            >
              ...
              requirements and create a tailored solution that fits your vision
              and budget.
            </p>
            <button
              onClick={() => scrollToSection("contact")}
            ...
            >
              Get <span className="text-red-500">Custom Quote →</span>
            </button>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 mt-5">
            ...
            >
              Ready to bring your ideas to life? Let's discuss to create something amazing.
            </p>
          </div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="flex gap-4 mt-8">
                  ...
                  <button
                    className={`flex-1 border py-3 rounded-lg font-semibold transition-all duration-300 hover:bg-opacity-50 flex items-center justify-center gap-2 ${
                      isDarkMode
                        ? "border-gray-600 hover:border-gray-400 text-white hover:bg-gray-800/50"
                        : "border-gray-400 hover:border-gray-600 text-black hover:bg-gray-200/50"
                    }`}
