      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-6">
        ...
        <div className="text-center mb-8">
          <h1 className={`text-3xl font-bold mb-2 ${
            ...
            Welcome to saketh<span className="text-red-500">sirx</span>
          </h1>
          <p className={`${
        ...
        <div className="text-center mt-8">
          ...
          By continuing, you agree to our <span className="text-red-500"><br></br>"Terms of Service and Privacy Policy"</span>
          </p>
        </div>
      </div>
    </div>
